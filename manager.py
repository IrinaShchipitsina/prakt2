...
def print_help_string():
    help_string = r''''pwf' -- вывести рабочую директорию.
'mkfld [folder_name] [folder_name] ..' - создание папок.
'mkflds [folder_name] [folder_name] ..' - создание папок внутри папок рекурсивно.
'rmfld [folders_name] [folder_name] ..' - удалить папку.
'rmflds [folder_name] [folder_name] ..' - удалить папки рекурсивно.
'gtf [folder_name]' - изменить рабочую директорию на заданную.
'crtfl [file_name] [file_name] ..' - создание файла.
'wrtfl [file_name]' - записать в файл.
'rdfl [file_name] [file_name] ..' - показать файлы.
'rmfl [file_name] [file_name] ..' - удалить файлы.
'cpflfd [file_from] [file_to]' - скопировать file_name в folder/new_file.
'rpls [file_folder] [file_folder1]' - переместить file_folder в file_folder1.
'rnm [file_folder]' - переименовать.
'exit' - выход.
